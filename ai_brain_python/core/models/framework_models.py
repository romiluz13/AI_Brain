...
class CrewAIConfig(FrameworkConfig):
    ...
    framework_type: FrameworkType = Field(default=FrameworkType.CREWAI, const=True)
...
class PydanticAIConfig(FrameworkConfig):
    ...
    framework_type: FrameworkType = Field(default=FrameworkType.PYDANTIC_AI, const=True)
...
class AgnoConfig(FrameworkConfig):
    ...
    framework_type: FrameworkType = Field(default=FrameworkType.AGNO, const=True)
...
class LangChainConfig(FrameworkConfig):
    ...
    framework_type: FrameworkType = Field(default=FrameworkType.LANGCHAIN, const=True)
...
class LangGraphConfig(FrameworkConfig):
    ...
    framework_type: FrameworkType = Field(default=FrameworkType.LANGGRAPH, const=True)
